...
BERT是transformer的encoder部分。在这篇文章当中，介绍了很多接上BERT之后的下游任务。可以认为通过BERT，可以更好地学习输入语句的representation，之后利用这些representation进行下游任务。

![image](https://user-images.githubusercontent.com/36061421/137551473-b6b2c41a-78fc-4d5d-b4fe-3330753afb5b.png)

training的时候，可以选择两种策略并行的方式：

1.利用mask的方式，让下游输出去做预测。

![image](https://user-images.githubusercontent.com/36061421/137551537-0967d0be-0a53-4e1f-aeaa-eeae568d245c.png)

2.预测句子之间的间隔

![image](https://user-images.githubusercontent.com/36061421/137551654-ed93ea43-8bba-4372-bf08-b4221e649aa2.png)
...
![image](https://user-images.githubusercontent.com/36061421/137551775-30142401-4aad-4146-96b4-76a7eaac2d75.png)

2.词性分类

![image](https://user-images.githubusercontent.com/36061421/137551856-934ad0db-4203-4861-9d5c-2d0b7c005873.png)

3.推断

![image](https://user-images.githubusercontent.com/36061421/137551970-8404e9ae-72eb-4c9c-87d4-a15a0bfb00e3.png)

4.问答

![image](https://user-images.githubusercontent.com/36061421/137552010-e3781694-7758-43d5-9b7c-3ba84af6bbe0.png)

注意，这种问答的答案是原原本本地出现在文本当中的。s和e框定了答案的范围，最终答案就在文本之中。

![image](https://user-images.githubusercontent.com/36061421/137552154-3cab0573-d9b0-4b98-8868-3294af0cf921.png)

在训练的时候，可以加两个vector，分别对开头和结尾进行控制。

ERNIE是基于BERT，在中文上面的改进。如果还是像bert那样对single character进行mask，对于中文而言比较简单。因此在这个模型中，加大了mask的难度，变成了词汇。更好地对中文进行了适配。

![image](https://user-images.githubusercontent.com/36061421/137552304-396a8674-4b5b-4d78-bbc1-b0b9cc28db40.png)

关于BERT，还有一个神奇的地方在于，在让BERT学会英文文本分类之后，它居然可以在没学过中文的情况下对中文文本也进行分类。
...
GPT相当于transformer的decoder部分，可以实现一些比较惊人的zero-shot learning。一些原因也在于这个模型本身就很大。

![image](https://user-images.githubusercontent.com/36061421/137553813-ffdb21d3-f760-4ce9-8209-424b2249b50f.png)

它的架构：

![image](https://user-images.githubusercontent.com/36061421/137553870-7b02713b-85a6-469f-aff2-58721c2800ad.png)

GPT可以做以下任务：

![image](https://user-images.githubusercontent.com/36061421/137553907-5719444a-508d-40a1-b594-b043d7469332.png)

在以上任务中，有些任务GPT可以zero-shot之下也有比较好的结果，但有的就像是random的结果，效果不佳。GPT的文本生成功能还是比较令人印象深刻的。
